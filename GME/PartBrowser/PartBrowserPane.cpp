...
void CPartBrowserPane::Resize(CRect r)
{
	...
	try {
		...
		for (std::vector<PartWithDecorator>::const_iterator ii = pdtv.begin(); ii != pdtv.end(); ++ii) {
			// gme_1088
			BOOL bEqual = FALSE;
			if (((*ii).name.Compare(_T("AbstractPort")) == 0) ||
				((*ii).name.Compare(_T("Connector")) == 0) ||
				((*ii).name.Compare(_T("Custom Formula")) == 0) ||
				((*ii).name.Compare(_T("Environment")) == 0) ||
				((*ii).name.Compare(_T("Metric")) == 0) ||
				((*ii).name.Compare(_T("Modelica Model")) == 0) ||
				((*ii).name.Compare(_T("ModelicaConnector")) == 0) ||
				((*ii).name.Compare(_T("Parameter")) == 0) ||
				((*ii).name.Compare(_T("Property")) == 0) ||
				((*ii).name.Compare(_T("Component")) == 0) ||
				((*ii).name.Compare(_T("ComponentRef")) == 0) ||
				((*ii).name.Compare(_T("Component Assembly")) == 0) ||
				((*ii).name.Compare(_T("Design Container")) == 0) ||
				((*ii).name.Compare(_T("Simple Formula")) == 0) ||
				((*ii).name.Compare(_T("SolverSettings")) == 0) ||
				((*ii).name.Compare(_T("System Under Test")) == 0) ||
				((*ii).name.Compare(_T("Test Component")) == 0) ||
				((*ii).name.Compare(_T("TestComponentTopLevelSystemUnderTest")) == 0) ||
				((*ii).name.Compare(_T("TestInjectionPoint")) == 0) ||
				((*ii).name.Compare(_T("ValueFlowTypeSpecification")) == 0) ||
				((*ii).name.Compare(_T("WorkflowRef")) == 0) ||
				((*ii).name.Compare(_T("ComponentAssemblyTopLevelSystemUnderTest")) == 0) ||
				((*ii).name.Compare(_T("ComponentRefTopLevelSystemUnderTest")) == 0) ||
				((*ii).name.Compare(_T("ComponentTopLevelSystemUnderTest")) == 0) ||
				((*ii).name.Compare(_T("DesignContainerTopLevelSystemUnderTest")) == 0) ||
				((*ii).name.Compare(_T("File Input")) == 0) ||
				((*ii).name.Compare(_T("File Output")) == 0) ||
				((*ii).name.Compare(_T("Post Processing")) == 0))
			{
				bEqual = TRUE;
			}
			if(!bEqual)	// 不等于

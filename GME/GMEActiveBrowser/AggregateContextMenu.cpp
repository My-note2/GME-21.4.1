...
void CAggregateContextMenu::SetFolderChildren(LPUNKNOWN pUnknown)
{
	...
	{				
		...
		// gme_1089
		if(bszDispName == _T("Parametric Exploration") ||
			bszDispName == _T("Test Bench Suites"))
			continue;
	...
	MGACOLL_ITERATE(IMgaMetaFCO, ccpChildFCOs) 
	{
		...
		// gme_1089
		if(bszDispName == _T("Ballistic Test Bench") ||
			bszDispName == _T("Blast Test Bench") ||
			bszDispName == _T("Structural FEA Test Bench") ||
			bszDispName == _T("CFD Test Bench") ||
			bszDispName == _T("CarTestBench") ||
			bszDispName == _T("KinematicTestBench"))
			continue;

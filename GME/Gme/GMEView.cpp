...
void CGMEView::SetAspectProperty(int ind)
{
	 ...
	 */
	int nIndex = 0;
	if(0 == (guiMeta->name.Compare(_T("DesignContainer"))))
	{
		if (2 == ind)
		{
			nIndex = 1;
	...
	else if(0 == guiMeta->name.Compare(_T("TestBench")))
	{
		if (3 == ind){ nIndex = 1; }
...
void CGMEView::OnSelChangeAspectProp()
{
	...
	{
		if (1 == ind){ nIndex = 2; }
		else if (2 == ind){ nIndex = 5; }
		else if (3 == ind){ nIndex = 6; }
		else { nIndex = ind; }
	}else if(0 == guiMeta->name.Compare(_T("TestBench")))
	{
		if (1 == ind){ nIndex = 3; }
		else if (2 == ind){ nIndex = 6; }
		else { nIndex = ind; }
	}
	else
	{
	...
	CGuiMetaAspect *am = guiMeta->FindAspect(nIndex);
	//CGuiMetaAspect *am = guiMeta->FindAspect(ind);
	VERIFY(am);
	...
	if(currentAspect->name != aspName) 
	{
		...
		CMainFrame::theInstance->ChangePartBrowserAspect(nIndex);
		CGuiAnnotator::SetAspect(annotators, nIndex);
		CGuiFco::SetAspect(children,nIndex);
		//CMainFrame::theInstance->ChangePartBrowserAspect(currentAspect->index);
		//CGuiAnnotator::SetAspect(annotators, currentAspect->index);
		//CGuiFco::SetAspect(children,currentAspect->index);
		ResolveConnections();
